...
<input type="text" name="Items"/>
    <h2> Quantity </h2>
    <input type="number" name="Quantity"/></center><br/>
    <center><button type="submit" name="add"><b>ADD</b></button></br>
...
$conn=mysqli_connect("localhost","root","mysql","hotel");
 if(!$conn){
  ...
  if(isset($_POST["add"]))
 {
   $res =mysqli_query($conn,"insert into palace values($_POST[Item_Id],'$_POST[Items]',$_POST[Quantity])");
   if(!$res){
